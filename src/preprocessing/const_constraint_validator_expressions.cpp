...
void CCV::SingleFunctionConstConstraintValidator::visit_expression(const Expression& statement, ScopeContext& scope_context) {
...
void CCV::SingleFunctionConstConstraintValidator::visit_type_operator(
...
void CCV::SingleFunctionConstConstraintValidator::visit_binary_operator(
...
void CCV::SingleFunctionConstConstraintValidator::visit_unary_operator(
...
void CCV::SingleFunctionConstConstraintValidator::visit_array_literal(
...
void CCV::SingleFunctionConstConstraintValidator::visit_dot_member_access(
...
void CCV::SingleFunctionConstConstraintValidator::visit_square_bracket_access(
